...
export default class Button extends React.Component<any, any> {
    ...
    constructor(props: any) {
        ...
        console.log('this.buttonRef :', this.buttonRef, this.buttonRef.current);
    }
    ...
    getClassNames() {
        ...
        return `rainbow-button ${this.getVariantClassNames()}${isShaded ? ' rainbow-button--shaded' : ''}${isLoading && variant !== 'base' ? ' rainbow-button--loading' : ''}${className ? className : ''}`;
